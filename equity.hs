...
forwardrate :: (RealFloat a, U.Unbox a)=>Equity a b->a->a->a
forwardrate (Equity _ _ rf div _ _) t1 t2 = (forward rf t1 t2)-(forward div t1 t2)

charfunc :: (CharFunc a, RealFloat b, U.Unbox b)=>Equity b (a b)->b->(Complex b->Complex b)
